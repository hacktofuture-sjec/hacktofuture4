    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "due_date",
                    models.DateField(blank=True, help_text="ISO-8601 date", null=True),
                ),
                (
                    "provider_metadata",
                    models.JSONField(
                ...
                (
                    "labels",
                    models.JSONField(
                        default=list, help_text="JSONB list of label strings"
                    ),
                ),
                (
                    "source_created_at",
                    models.DateTimeField(
                        blank=True, help_text="When created in source system", null=True
                    ),
                ),
                (
                    "source_updated_at",
                    models.DateTimeField(
                        blank=True,
                        help_text="When last updated in source system",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "body_html",
                    models.TextField(
                        blank=True, help_text="Rendered HTML if available"
                    ),
                ),
                (
                    "is_internal",
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["provider_metadata"], name="ticket_prov_meta_gin_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="unifiedticket",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["ticket", "-source_created_at"], name="comment_ticket_time_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="ticketcomment",
            constraint=models.UniqueConstraint(
                condition=models.Q(("external_comment_id", ""), _negated=True),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["ticket", "-occurred_at"], name="activity_ticket_time_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="externalidentity",
            index=models.Index(
                fields=["organization", "integration"], name="extidentity_org_int_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="externalidentity",
