...
export default function Dashboard({ stats, clusters, repoName, onRunPipeline }) {
  ...
  const pieData = [
    { name: "GitHub",  value: stats.feedback_by_source?.github     || 0 },
    { name: "Reddit",  value: stats.feedback_by_source?.reddit     || 0 },
    { name: "Twitter", value: stats.feedback_by_source?.twitter    || 0 },
    { name: "HN",      value: stats.feedback_by_source?.hackernews || 0 },
  ].filter((d) => d.value > 0);
